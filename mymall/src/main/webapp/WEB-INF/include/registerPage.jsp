...
var hadoop=function(){
	...
	var uri="${pageContext.request.contextPath}/user/registerName?name="+$("#name").val();
...
$(function(){
	...
	$(".registerForm").submit(function(){
		...
		if($("span.errorMessage").val=="用户名已存在"){
			return false;
		}
...
<form method="post" action="${pageContext.request.contextPath}/user/register" class="registerForm">
...
<div class="registerDiv">
	...
	<table class="registerTable" align="center">
		...
		<tr>
			...
			<td  class="registerTableRightTD"><input id="name" name="name" placeholder="会员名一旦设置成功，无法修改" onblur="hadoop()" > </td>
		</tr>
		<tr>
