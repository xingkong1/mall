				...
				<div class="panel panel-warning addPictureDiv">
					<div class="panel-heading">新增产品<b class="text-primary"> 单个 </b>图片</div>
					  <div class="panel-body">
					    	<form method="post" class="addFormSingle" action="${pageContext.request.contextPath}/productImage/add" enctype="multipart/form-data">
						...
						<c:forEach items="${p.productSingleImages}" var="pi">
							<tr>
								...
								<td><a deleteLink="true"
									href="${pageContext.request.contextPath}/productImage/delete/${pi.id}"><span
			  ...
			  <div>
				...
				<div class="panel panel-warning addPictureDiv">
					<div class="panel-heading">新增产品<b class="text-primary"> 详情 </b>图片</div>
					  <div class="panel-body">
					    	<form method="post" class="addFormDetail" action="${pageContext.request.contextPath}/productImage/add" enctype="multipart/form-data">
					    		<table class="addTable">
					    			<tr>
